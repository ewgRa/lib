...
{
	if( DYNAMIC == 'false' || DYNAMIC == false ) return true;
	if( !Settings['method'] ) Settings['method'] = 'GET';
	// Create new JsHttpRequest object.
	var req = new JsHttpRequest();
	Settings['caching'] ? req.caching = true : req.caching = false;
	...
	req.onreadystatechange = function()
	{
		if (req.readyState == 4)
		{
			...
			for( i in Settings['callback_function'] )
			{
				if( typeof( Settings['callback_function'][i] ) == 'function' ) Settings['callback_function'][i]( req.responseJS, Settings );
				else if( typeof( Settings['callback_function'][i] ) == 'string' ) 
				{
					eval( Settings['callback_function'][i] + '( req.responseJS, Settings );' );
				}
			}
			//if( Settings['value'].onsubmit ) Settings['value'].onsubmit = Settings['value'].onsubmit;			
		}
	}
	// Prepare request object (automatically choose GET or POST).
	req.open( Settings['method'], Settings['script'], ASYNC );
	// Send data to backend.
	req.send( Settings['value'] );
	return false;
}
